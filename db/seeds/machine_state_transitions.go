...
var MachineStateTransitions = []MachineStateTransition{
	{
		...
		Actions:     "",
		Risk:        "Bajo",
		Note:        "Initial transition to start the machine",
	},
	{
		ID:          "T002",
		SourceState: "CIV.ORD.S00",
		...
		Actions:     "Crear checklist de demanda ordinaria",
		Risk:        "Medio",
		Note:        "Art. 638",
	},
	{
		...
		Condition:   "",
		TargetState: "CIV.ORD.S01",
		Actions:     "Crear expediente; conservar acuse y fecha/hora",
		Risk:        "Alto",
		Note:        "Arts. 612, 614, 623",
	},
	{
		ID:          "T004",
		SourceState: "CIV.ORD.S01",
		EventID:     "CIV.ORD.E004",
		Condition:   "demanda_y_anexos_registrados = TRUE",
